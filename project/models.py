...
class Course(models.Model):
    ...
    department = models.CharField(max_length=255)  # Department offering the course
    description = models.TextField()  # Detailed course description
    credits = models.IntegerField()  # Number of credits awarded for the course

    def __str__(self):
        return self.course_name


# Model for an academic track, linked to a user and specifying the year (e.g., Freshman, Sophomore).
...
class AcademicTrackCourse(models.Model):
    ...
    year_taken = models.IntegerField()  # Year when the course was taken
